...
Item {
    ...
    property color effectColor: Config.colours.accentPrimary
    ...
    function triggerUnifiedWave() {
        effectColor = Config.colours.accentPrimary;
    ...
    function updateWorkspaceFocus() {
        for (let i = 0; i < localWorkspaces.count; i++) {
            ...
            if (ws.isFocused === true) {
                ...
                root.workspaceChanged(ws.id, Config.colours.accentPrimary);
                break;
            }
        }
    }
    ...
    /*Rectangle {
        ...
        border.color: Qt.rgba(Config.colours.textPrimary.r, Config.colours.textPrimary.g, Config.colours.textPrimary.b, 0.1)
        border.width: 1
        layer.enabled: true
        layer.effect: DropShadow {
            color: Config.colours.shadow
            radius: 12
            samples: 24
            verticalOffset: 0
            horizontalOffset: 0
            ...
            Item {
                ...
                Rectangle {
                    ...
                    color: {
                        ...
                        if (model.isActive)
                            return Config.colours.accentPrimary.lighter(130);
                        if (model.isUrgent)
                            return Config.colours.error;
                        return Qt.lighter(Config.colours.surfaceVariant, 1.6);
                    }
